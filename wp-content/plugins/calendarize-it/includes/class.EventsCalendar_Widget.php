...
<?php endforeach;?>
	...
	<div class="" style="margin-top:10px;">
		...
		<select id="<?php echo $this->get_field_id('view')?>" name="<?php echo $this->get_field_name('view')?>" class="widefat">
			...
			<option value="<?php echo $value?>" <?php echo $value==$instance['view']?'selected="selected"':''?> ><?php echo $label?></option>
			<?php endforeach;?>
		</select>
	</div>
	<div class="" style="margin-top:10px;">
		...
		<select id="<?php echo $this->get_field_id('theme')?>" name="<?php echo $this->get_field_name('theme')?>" class="widefat">
			...
			<option value="<?php echo $value?>" <?php echo $value==$instance['theme']?'selected="selected"':''?> ><?php echo $label?></option>
			<?php endforeach;?>
		</select>
	</div>
	<div class="" style="margin-top:10px;">
